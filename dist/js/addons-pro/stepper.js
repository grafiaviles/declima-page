...
(function (factory) {
  ...
  $.extend($.validator, {
    ...
    messages: {
      ...
      remote: "Por favor intenta corregir la info introducida.",
      ...
      equalTo: "Por favor ingresa un valor igual al de arriba.",
      maxlength: $.validator.format("Por favor no pueden ser mas de {0} caracteres."),
      minlength: $.validator.format("Por favor no pueden ser menos de {0} caracteres."),
      rangelength: $.validator.format("Por favor ingresa un valor entre {0} y {1} caracteres de largo."),
      range: $.validator.format("Disculpa solo puedes ingresar valores entre {0} y {1}."),
      max: $.validator.format("Solo puedes ingresar valores menores o iguales a {0}."),
      min: $.validator.format("Solo puedes ingresar valores mayores o iguales a {0}."),
      step: $.validator.format("Por favor ingresa solo multiplos de {0}.")
    },
